          ...
          @if(Auth::user()->user_type == "faculty")
            <form method="post" action="{{ route('results.store') }}" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
              ...
              <div class="card ">
                ...
                <div id="accordionf" class="accordion">
                  <div class="card mb-0">
                    <div class="card-header card-header-primary collapsed" data-toggle="collapse" href="#collapsef">
                      <h4 class="card-title">{{ __('Click to Add Result') }}</h4>
                      <p class="card-category"></p>
                    </div>
                      
                      <div id="collapsef" class="collapse" data-parent="#accordionf">
                          <div class="card-body ">
                            ...
                            @foreach($results as $result)
                              @if($result->department == "Computer Science" && $result->batch == "Third Year" && $result->type == "Regular")
                                <tr>
                                  ...
                                  <td>@if(Auth::user()->user_type == "faculty")<button type="submit" class="btn btn-danger" data-rid="{{$result->id}}" data-toggle="modal" data-target="#delete1">Delete</button>@endif</td>
                                  <td></td>
                                </tr>
                              @endif
                            @endforeach
