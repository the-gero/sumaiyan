                ...
                <div class="bmd-form-group{{ $errors->has('department') ? ' has-danger' : '' }} mt-3">
                  <div class="input-group">
                    <div class="input-group-prepend">
                      ...
                      <input class="btn dropdown-toggle" type="text" name="department" id="department" readonly value="{{ old('department', $user->department) }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" required>
                ...
                <div class="bmd-form-group{{ $errors->has('batch') ? ' has-danger' : '' }} mt-3">
                  <div class="input-group">
                    <div class="input-group-prepend">
                      ...
                      <input class="btn dropdown-toggle" type="text" name="batch" id="batch" readonly value="{{ old('batch', $user->batch) }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" required  >
